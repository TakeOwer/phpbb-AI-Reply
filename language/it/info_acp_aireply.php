...
$lang = array_merge($lang, [
	...
	/*
	 * Voci del registro attivita'.
	 *
	 * Stanno qui e non in acp_aireply.php perche' quel file phpBB lo carica
	 * soltanto quando si aprono le schede dell'estensione. La pagina del
	 * registro e' un'altra sezione dell'ACP: li' vedrebbe le chiavi grezze,
	 * tipo "{LOG AIREPLY BOT SAVED}". Questo file invece viene caricato in
	 * tutto il pannello.
	 */
