...
'AIREPLY_ERR_MODEL_RETIRED' => 'Model "%1$s" has been closed by Google to new accounts: it still appears in the list but can no longer be used. Change it in the bot\'s "Model" field. Recommended: <code>%2$s</code>, which is an alias and always points to a live version. There is no need to migrate to another API, despite what Google\'s message suggests.',
	...
	// --- Board description sent to the model --------------------------------
	'AIREPLY_CTX_BOARD'   => 'Forum:',
	'AIREPLY_CTX_CURRENT' => 'Section you are replying in:',
	'AIREPLY_CTX_SECTIONS' => 'Forum sections visible to the person who wrote to you:',
	'AIREPLY_CTX_RULE'    => 'On the structure of the forum use only the information above. If something is not listed, say you do not know rather than assuming: pointing someone to a section that does not exist is worse than admitting you are unsure. Sections marked with · are the ones you can post in; the others are categories containing them.',

	// --- Related discussions search ----------------------------------------
	'AIREPLY_SEARCH_HEADER' => 'Existing discussions on the forum that look related to the question:',
	'AIREPLY_SEARCH_RULE'   => 'You know only the title, section and date of these discussions: you do not know what they contain. Point to them only if they are genuinely relevant to what was asked, with their link, and do not summarise them. If one is old, say so, because it may hold outdated information. If none is relevant, ignore this list and do not mention it.',
