...
$lang = array_merge($lang, [
	...
	'AIREPLY_TEMPLATE_EXPLAIN'       => 'Available placeholders: {response} the generated text, {disclosure} the automated-content notice, {model} and {provider}. Leave empty to use "{response}" followed by the notice. The notice is added anyway if you omit it.',
	...
	// --- Forums tab ------------------------------------------------------
	'AIREPLY_FORUMS_INTRO'   => 'Assign the bot that should reply in each forum and choose when it steps in. Forums with no bot assigned are simply ignored. Categories are listed but not configurable: they cannot hold posts.',
